...
<head>
        ...
        <title>West Asia Group | Contact Us</title>
    ...
    <body>
		...
		<div class="header-bennar-area">
			<div class="bennar-content">				
				<h2>Contact Us</h2>
				<!-- <p>Suspendisse convallis purus vitae turpis tempus, ut semper risus tincidunt.</p> -->
			</div>
		</div>
			...
			<div class="container">
				<div class="row">
					<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
						<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d15843.481374029227!2d79.85759416297897!3d6.906103970157457!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3ae259706bfa613f%3A0xf79d7adae85305f7!2sColombo+07%2C+Colombo!5e0!3m2!1sen!2slk!4v1527099671384" width="500" height="200" frameborder="0" style="border:0" allowfullscreen></iframe>
						<div class="contact-us-area">
						   <h3>Contact Us</h3>
						   <ul>
							   	<li>Address: West Asia Group Ltd. 255, Ward Place, Colomb0 -07</li>
							   	<li>Phone: +(112) 345 6879</li>
							   	<li>Fax: +(112) 345 8796</li>
							   	<li>Email: contact@westasiagroup.lk</li>
							</ul>
						</div>
					</div>
                              ...
                              <form method="post" action="#" name="cform" id="cform">
							    <fieldset>
							      ...
							      <div class="col-sm-12">
                                    ...
                                    <input type="button" name="send" value="Send Mail" id="submit" class="dt-button white alt"/>
							      </div>
        ...
        <script src="https://maps.googleapis.com/maps/api/js"></script>
	        ...
	        var map = new google.maps.Map(document.getElementById('googleMap','contact'),
	          mapOptions);
...
<!-- Mirrored from demo.themelocation.com/discover/contact.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 19 Mar 2018 17:13:53 GMT -->
</html>
