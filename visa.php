...
<head>
        ...
        <title>West Asia Group | Visa</title>
    ...
    <body>
		...
		<div class="header-bennar-area">
			<div class="bennar-content">				
				<h2>All Visa</h2>
				<p>All kind of VISA facilitator in the region</p>
			</div>
		</div>
					...
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<div class="breadcumb">
							<ul>
								...
								<li><a href="#"><i class="fa fa-angle-right"></i>Visa</a></li>
							</ul>
						</div>
					</div>
				</div>
		...
		<div class="all-room-one-inner-area">
			<div class="container">
				<div class="single-rooms1-area">
					<div class="row">
						<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
							<div class="single-rooms1-feature-image">
								<a href="#"><img src="img/2/1.jpg" alt="images"></a>
							</div>
						</div>
						<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
							<div class="rooms1-facility-area">
								<h2>Russia</h2>
								<p>Nunc aliquam eros lacus, ut tincidunt orci imperdiet id. In cursus at lacus eget lacinia. Quisque elementum sem risus, quis laoreet odio dignissim ac. Proin massa nibh, condimentum at ex eget, volutpat fringilla lectus. Curabitur dignissim varius dictum. Praesent orci nulla, convallis sed elit quis, finibus vestibulum metus. Nunc maximus magna eros, sed ullamcorper tellus pellentesque vitae. Nam fermentum eros quis diam vehicula dignissim. </p>
							</div>
						</div>
						...
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
								<div class="room-facility-list">
									<nav>
										<ul>
											<li><a href="#"><i class="fa fa-star" aria-hidden="true"></i> Tourist Visa</a></li>
											<li><a href="#"><i class="fa fa-star" aria-hidden="true"></i> Business Visa</a></li>
											<li><a href="#"><i class="fa fa-star" aria-hidden="true"></i> Transit Visa</a></li>
											<li><a href="#"><i class="fa fa-star" aria-hidden="true"></i> Student Visa</a></li>
											<li><a href="#"><i class="fa fa-star" aria-hidden="true"></i> Safe Deposit</a></li>
											<li><a href="#"><i class="fa fa-star" aria-hidden="true"></i> Temporary worker Visa</a></li>
										</ul>
									</nav>
								 </div>
							</div>
							<div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
								<div class="room-facility-list">
									...
									<nav>
										<ul>
											<li><a href="#"><i class="fa fa-star" aria-hidden="true"></i> Parent Visa</a></li>
											<li><a href="#"><i class="fa fa-star" aria-hidden="true"></i> Spousal Visa</a></li>
											<li><a href="#"><i class="fa fa-star" aria-hidden="true"></i> Partner Visa</a></li>
											<li><a href="#"><i class="fa fa-star" aria-hidden="true"></i> Russian Marriage Visa</a></li>
											<li><a href="#"><i class="fa fa-star" aria-hidden="true"></i> Work Permit</a></li>
										</ul>
									</nav>
								</div>
						</div>
...
<!-- Mirrored from demo.themelocation.com/discover/room2.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 19 Mar 2018 17:14:09 GMT -->
</html>
